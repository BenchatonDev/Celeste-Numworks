...
CPPFLAGS += -Os -Wall -DCELESTE_P8_FIXEDP -fpermissive
...
.PHONY: build
build: $(BUILD_DIR)/Celeste.bin

.PHONY: run
run: $(BUILD_DIR)/Celeste.nwa
	@echo "INSTALL $<"
...
$(BUILD_DIR)/Celeste.nwa: $(call object_for,$(src)) $(BUILD_DIR)/icon.o
	@echo "LD      $@"
